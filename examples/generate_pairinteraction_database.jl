...
const MODELS_TABLE = Dict(
    ...
    :Yb171 => [MQDT.Yb171.MODEL_S05, MQDT.Yb171.MODEL_S15,
               MQDT.Yb171.MODEL_P05, MQDT.Yb171.MODEL_P15, MQDT.Yb171.MODEL_P25,
               MQDT.Yb171.MODEL_D05, MQDT.Yb171.MODEL_D15, MQDT.Yb171.MODEL_D25, MQDT.Yb171.MODEL_D35],
...
para = PARA_TABLE[SP]
c_states = MQDT.eigenstates(1.5, 2.5, MQDT.Yb174.MODEL_G1, para) # clock states # TODO  make it work for SP != Yb174
r_states = [MQDT.eigenstates(n1, n2, M, para) for M in models] # Rydberg states

# generate state table
c_basis = MQDT.basisarray(c_states, MQDT.Yb174.MODEL_G1) # TODO make it work for SP != Yb174
...
c_db = MQDT.databasearray(c_states, MQDT.Yb174.MODEL_G1) # TODO make it work for SP != Yb174
