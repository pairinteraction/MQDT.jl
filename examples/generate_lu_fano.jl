...
# S series of Yb171
f = 0.5
s_S05 = MQDT.eigenstates(24, 129, MQDT.Yb171.FMODEL_HIGHN_S05, MQDT.Yb171.PARA)
b_S05 = MQDT.basisarray([s_S05], [MQDT.Yb171.FMODEL_HIGHN_S05])
m_S05 = diag(MQDT.matrix_element(MQDT.Yb171.PARA, b_S05))
g_S05 = -2m_S05 / f * wigner3j(1, 0, f, f, f, f)

f = 1.5
s_S15 = MQDT.eigenstates(24, 129, MQDT.Yb171.FMODEL_HIGHN_S15, MQDT.Yb171.PARA)
b_S15 = MQDT.basisarray([s_S15], [MQDT.Yb171.FMODEL_HIGHN_S15])
...
scatter!(s_S05.n, mod.(-s_S05.nu[7,:], 1), title="171Yb S series", subplot=1, label="F=1/2")
...
# P series of Yb171
f = 0.5
s_P05 = MQDT.eigenstates(10, 70, MQDT.Yb171.FMODEL_HIGHN_P05, MQDT.Yb171.PARA)
b_P05 = MQDT.basisarray([s_P05], [MQDT.Yb171.FMODEL_HIGHN_P05])
m_P05 = diag(MQDT.matrix_element(MQDT.Yb171.PARA, b_P05))
g_P05 = -2m_P05 / f * wigner3j(1, 0, f, f, f, f)

f = 1.5
s_P15 = MQDT.eigenstates(10, 70, MQDT.Yb171.FMODEL_HIGHN_P15, MQDT.Yb171.PARA)
b_P15 = MQDT.basisarray([s_P15], [MQDT.Yb171.FMODEL_HIGHN_P15])
