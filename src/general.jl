...
from this we can extract nu_min = 3 and nu_max NaN.

Some Model names also contain a upper limit, e.g. Yb174.FMODEL_LOWN_P1: "P J=1, 1.7 < ν < 2.7",
from which we extract nu_min = 3 and nu_max = 3.
"""
