...
MODEL_S35 = Model(
    ...
    [0;;],
    [1 0 1],
    fjChannels([0.5], [0], [0.5], [4], [0.5], [0], [0.5], [3.5]),
    [1;;]
)
...
MODEL_S45 = Model(
    ...
    [0;;],
    [0 0 0; 1 0 1],
    fjChannels([0.5, 0.5], [0, 0], [0.5, 0.5], [4, 5], [0.5, 0.5], [0, 0], [0.5, 0.5], [4.5, 4.5]),
...
MODEL_S55 = Model(
    ...
    [0;;],
    [1 0 1],
    fjChannels([0.5], [0], [0.5], [5], [0.5], [0], [0.5], [5.5]),
    [1;;]
)
...
MODEL_CL = Model(
    ...
    fjChannels([0.5, 0.5, 0.5, 0.5], [0, 0, 0, 0], [0.5, 0.5, 0.5, 0.5], [4, 4, 5, 5], [0.5, 0.5, 0.5, 0.5], [1, 1, 1, 1], [0.5, 1.5, 0.5, 1.5], [4.5, 4.5, 4.5, 4.5]),
...
MODEL_P25 = Model(
    ...
    [0;;],
    [1 1 2],
    fjChannels([0.5], [0], [0.5], [4.0], [0.5], [1], [1.5], [2.5]),
    [1;;]
)
...
MODEL_P35 = Model(
    ...
    [0;;],
    [0 1 1; 1 1 1; 1 1 2],
    fjChannels([0.5, 0.5, 0.5], [0, 0, 0], [0.5, 0.5, 0.5], [4, 4, 5], [0.5, 0.5, 0.5], [1, 1, 1], [0.5, 1.5, 1.5], [3.5, 3.5, 3.5]),
...
MODEL_P55 = Model(
    ...
    [0;;],
    [0 1 1; 1 1 1; 1 1 2],
    fjChannels([0.5, 0.5, 0.5], [0, 0, 0], [0.5, 0.5, 0.5], [4, 5, 5], [0.5, 0.5, 0.5], [1, 1, 1], [1.5, 0.5, 1.5], [5.5, 5.5, 5.5]),
...
MODEL_P65 = Model(
    ...
    [0;;],
    [1 1 2],
    fjChannels([0.5], [0], [0.5], [5.0], [0.5], [1], [1.5], [6.5]),
    [1;;]
)
...
MODEL_D15 = Model(
    ...
    [0;;],
    [1 2 3],
    fjChannels([0.5], [0], [0.5], [5], [0.5], [2], [2.5], [1.5]),
    [1;;]
)
...
MODEL_D25 = Model(
    ...
    [-0.14 0;],
    [0 2 2; 1 2 2; 1 2 3],
    fjChannels([0.5, 0.5, 0.5], [0, 0, 0], [0.5, 0.5, 0.5], [4, 4, 5], [0.5, 0.5, 0.5], [2, 2, 2], [1.5, 2.5, 2.5], [2.5, 2.5, 2.5]),
...
MODEL_D35 = Model(
    ...
    fjChannels([0.5, 0.5, 0.5, 0.5], [0, 0, 0, 0], [0.5, 0.5, 0.5, 0.5], [4, 4, 5, 5], [0.5, 0.5, 0.5, 0.5], [2, 2, 2, 2], [1.5, 2.5, 1.5, 2.5], [3.5, 3.5, 3.5, 3.5]),
...
MODEL_D45 = Model(
    ...
    [-0.14 0;],
    [0 2 2; 1 2 1; 1 2 2; 1 2 3],
    fjChannels([0.5, 0.5, 0.5, 0.5], [0, 0, 0, 0], [0.5, 0.5, 0.5, 0.5], [4, 4, 5, 5], [0.5, 0.5, 0.5, 0.5], [2, 2, 2, 2], [1.5, 2.5, 1.5, 2.5], [4.5, 4.5, 4.5, 4.5]),
...
MODEL_D55 = Model(
    ...
    [-0.14 0;],
    [0 2 2; 1 2 1; 1 2 2; 1 2 3],
    fjChannels([0.5, 0.5, 0.5, 0.5], [0, 0, 0, 0], [0.5, 0.5, 0.5, 0.5], [4, 4, 5, 5], [0.5, 0.5, 0.5, 0.5], [2, 2, 2, 2], [1.5, 2.5, 1.5, 2.5], [5.5, 5.5, 5.5, 5.5]),
...
MODEL_D65 = Model(
    ...
    [-0.14 0;],
    [0 2 2; 1 2 2; 1 2 3],
    fjChannels([0.5, 0.5, 0.5], [0, 0, 0], [0.5, 0.5, 0.5], [4, 5, 5], [0.5, 0.5, 0.5], [2, 2, 2], [2.5, 1.5, 2.5], [6.5, 6.5, 6.5]),
...
MODEL_D75 = Model(
    ...
    [0;;],
    [1 2 3],
    fjChannels([0.5], [0], [0.5], [5], [0.5], [2], [2.5], [7.5]),
    [1;;]
)
...
MODEL_F45 = Model(
    ...
    fjChannels([0.5, 0.5, 0.5, 0.5], [0, 0, 0, 0], [0.5, 0.5, 0.5, 0.5], [4, 4, 5, 5], [0.5, 0.5, 0.5, 0.5], [3, 3, 3, 3], [2.5, 3.5, 2.5, 3.5], [4.5, 4.5, 4.5, 4.5]),
